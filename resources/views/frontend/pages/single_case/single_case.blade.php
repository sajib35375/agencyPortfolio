...
@section('content')
    ...
    <div class="breadcrumb-area" style="background-image:url({{ URL::to('') }}/admin/images/case/{{ $single_header->image }});">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
    ...
    <div class="page-content our-attoryney padding-top-120 padding-bottom-100">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <h1 style="margin-bottom: 40px;font-family: Impact;font-weight: 700;">{{ $single_case->title }}</h1>
                    <div class="blog-details-item">
                        <div class="case-studies-details-top">
                            <div class="thumb">
                                <img style="width: 751px;height: 545px;" src="{{ URL::to('') }}/admin/images/case/{{ $single_case->image }}" alt="blog">
                            </div>
                            <!-- <div class="case-studies-inner-text">
                                <a href="">
                                    <h4 class="title">Cyber Security solution for cura</h4>
                                </a>
                        ...
                        <p>{!! $single_case->overView !!}</p>
                        <h2 class="title padding-top-10">Feature</h2>
                        <p>{!! $single_case->result !!}</p>
                    </div>
                </div>
                <div class="col-lg-4">
                        ...
                        <ul>
                            <li>
                                <a href="#" class="service-widget">
                                    ...
                                    <div class="service-title">
                                        ...
                                        <h6 class="title">{{ $single_case->clients }}
                                        </h6>
                                    </div>
                                </a>
                            </li>
                            <li>
                                <a href="#" class="service-widget">
                                    ...
                                    <div class="service-title">
                                        <span>Budget</span>
                                        <h6 class="title">${{ $single_case->budget }}
                            ...
                            <li>
                                <a href="#" class="service-widget border-bottom">
                                    ...
                                    <div class="service-title">
                                        <span>Duration</span>
                                        <h6 class="title">{{ $single_case->duration }}
                                        </h6>
                                    </div>
                                </a>
                            </li>
...
{{--    </section>--}}
    ...
    <section class="testimonial-area bg-image-01 padding-top-120 padding-bottom-120" style="background-image:url({{ URL::to('') }}/admin/images/about/{{ $about->banner_img }});">
        <div class=" container ">
            <div class="row justify-content-center ">
                <div class="col-lg-8 ">
